...
export default function UpworkVirtualAssistantPage() {
  return (
    <div className="flex min-h-screen flex-col bg-white font-sans">
      <Header />
      <main className="flex-1">
        <VSLHero
          preheading="A Better Alternative to Upwork Virtual Assistants"
          heading="Tired of Upwork? Get a Dedicated Virtual Assistant. 10x Faster & 1/5th the Cost."
          postHeading="No more freelancer hunting. Get a fully-managed VA that delivers guaranteed results."
          altPreheading="AI Supercharged Alternative to Upwork Virtual Assistants"
          altHeading="Tired of Upwork? Get an AI Supercharged Virtual Assistant. 10x Faster & 1/5th the Cost."
          altPostHeading="No more freelancer hunting. Get a fully-managed VA with AI-powered accuracy."
        ...
        <TrustedBy />
        <Testimonials />
        <SayGoodbyeTo text="Say Goodbye To Unreliable Freelancers" />
        <CostInHouse />
