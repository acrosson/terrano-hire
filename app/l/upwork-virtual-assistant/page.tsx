    ...
    <div className="flex min-h-screen flex-col bg-white font-sans">
      ...
      <main className="flex-1">
        <VSLHero
          ...
          heading="Tired of Upwork? Get a Dedicated Virtual Assistant. 10x Faster & $79/week."
          ...
          altHeading="Tired of Upwork? Get an AI Supercharged Virtual Assistant. 10x Faster & $79/week."
