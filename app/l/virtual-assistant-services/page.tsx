    ...
    <div className="flex min-h-screen flex-col bg-white font-sans">
      ...
      <main className="flex-1">
        <VSLHero
          ...
          heading="Get a Virtual Assistant for Your Business. Offload your Busy Work. 10x Faster & 1/5th the Cost."
          ...
          altHeading="Get an AI Supercharged Virtual Assistant for Your Business. Offload your Busy Work. 10x Faster & 1/5th the Cost."
