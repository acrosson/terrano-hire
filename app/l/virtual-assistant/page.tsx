    ...
    <div className="flex min-h-screen flex-col bg-white font-sans">
      ...
      <main className="flex-1">
        <VSLHero
          ...
          heading="Get an Virtual Assistant. Offload your Busy Work. 10x Faster & $79/week."
          ...
          altHeading="Get an AI Supercharged Virtual Assistant. Offload your Busy Work. 10x Faster & $79/week."
